  ...
  return (
    <div className="min-h-screen p-4">
      ...
      <div className="music-card text-center mb-8">
        ...
        {/* Reproductor de YouTube - Abrir en nueva ventana */}
        {gameState.isPlaying && gameState.currentSong && isYouTubeUrl(gameState.currentSong.previewUrl) && (
          <div className="mb-6 p-4 bg-white/20 backdrop-blur-lg rounded-xl border border-white/30">
            ...
            <button
              onClick={() => window.open(gameState.currentSong!.previewUrl, '_blank')}
              className="w-full bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center"
            >
